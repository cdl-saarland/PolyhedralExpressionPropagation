...
;
; CHECK: [eval f(1)], s = 1607406
; CHECK: [eval f(2)], s = 2528952
; CHECK: [eval f(3)], s = 3437904
; CHECK: [eval f(4)], s = 4336601
; CHECK: [eval f(5)], s = 5228804
; CHECK: [eval f(47)], s = 8389918
; CHECK: [eval f(100)], s = 12336469
;
;    #include <stdio.h>
;
...
;    }
;
source_filename = "../polly/test/ExpProp/main_random_3.c"
...
for.body18:                                       ; preds = %for.cond16
  %tmp16 = add nsw i64 %indvars.iv, -2
  %arrayidx21 = getelementptr inbounds [100 x i32], [100 x i32]* @B, i64 0, i64 %tmp16
  %tmp17 = load i32, i32* %arrayidx21, align 4
  %tmp18 = add nsw i64 %indvars.iv, -1
  %arrayidx24 = getelementptr inbounds [100 x i32], [100 x i32]* @C, i64 0, i64 %tmp18
