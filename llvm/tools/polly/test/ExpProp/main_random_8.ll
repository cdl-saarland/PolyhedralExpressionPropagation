...
;
; CHECK: [eval f(1)], s = 999899
; CHECK: [eval f(2)], s = 1328250
; CHECK: [eval f(3)], s = 1656602
; CHECK: [eval f(4)], s = 1984946
; CHECK: [eval f(5)], s = 2313265
; CHECK: [eval f(47)], s = 2574581
; CHECK: [eval f(100)], s = 1984850
;
;    #include <stdio.h>
;
...
;    }
;
source_filename = "../polly/test/ExpProp/main_random_8.c"
...
for.body:                                         ; preds = %for.cond
  ...
  %arrayidx = getelementptr inbounds [100 x i32], [100 x i32]* @B, i64 0, i64 %indvars.iv1
  %tmp4 = trunc i64 %indvars.iv.next2 to i32
  store i32 %tmp4, i32* %arrayidx, align 4
  %tmp5 = add nsw i64 %indvars.iv1, -1
  %arrayidx2 = getelementptr inbounds [100 x i32], [100 x i32]* @C, i64 0, i64 %indvars.iv1
  %tmp6 = trunc i64 %tmp5 to i32
  store i32 %tmp6, i32* %arrayidx2, align 4
  %arrayidx4 = getelementptr inbounds [100 x i32], [100 x i32]* @B, i64 0, i64 %indvars.iv1
  %tmp7 = load i32, i32* %arrayidx4, align 4
  %arrayidx6 = getelementptr inbounds [100 x i32], [100 x i32]* @C, i64 0, i64 %indvars.iv1
  %tmp8 = load i32, i32* %arrayidx6, align 4
  %add7 = add nsw i32 %tmp7, %tmp8
  %arrayidx9 = getelementptr inbounds [100 x i32], [100 x i32]* @A, i64 0, i64 %indvars.iv1
...
for.cond11:                                       ; preds = %for.inc21, %for.end
  ...
  br i1 %exitcond, label %for.body13, label %for.end23
...
for.body13:                                       ; preds = %for.cond11
  ...
  %tmp10 = load i32, i32* %arrayidx17, align 4
  %add18 = add nsw i32 %tmp9, %tmp10
  %arrayidx20 = getelementptr inbounds [100 x i32], [100 x i32]* @B, i64 0, i64 %indvars.iv
