...
; IR:   %2 = add nsw i64 %polly.indvar4, 8
; IR:   %p_tmp = mul nuw nsw i64 %2, 5
...
;
source_filename = "/home/johannes/projects/llvm/polly/test/ExpProp/phi_recompute_5.c"
...
for.cond2:                                        ; preds = %for.inc10, %for.end
  %indvars.iv = phi i64 [ %indvars.iv.next, %for.inc10 ], [ 11, %for.end ]
