...
; IR:   %p_add = fadd double %p_conv, 3.000000e+00
; IR:   %p_conv1 = fptrunc double %p_add to float
; IR:   %scevgep = getelementptr float, float* %B, i64 %polly.indvar
; IR:   store float %p_conv1, float* %scevgep
;
; IR: @g
;
; IR: polly.stmt.for.body.split:                        ; preds = %polly.loop_header
...
; IR:   store float %p_conv1, float* %scevgep
;
source_filename = "/home/johannes/projects/llvm/polly/test/ExpProp/types_1.c"
